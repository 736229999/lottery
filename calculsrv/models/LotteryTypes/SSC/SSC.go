...
//初始化彩票
func Init(lif gb.LotteryInfo) (*SSC, error) {
	ltry := &SSC{}
...
//更新彩票信息
func (o *SSC) updataInfo(newestRecord gb.LtryRecordByNewest) {
	//保存API获取的数据结构
...
//开采
func (o *SSC) StartLottery(newestRecord gb.LtryRecordByNewest) {
...
func (o *SSC) CheckLostExpect(gameTag string, newestRecord gb.LtryRecordByNewest, nextExpect int) {
...
func (o *SSC) updateGsLtryRecord() error {
...
//更新GameServer的彩票信息
func (o *SSC) updataGsLotteryInfo() {
	//组消息
...
//解析投注
func (o *SSC) AnalyticalBetting(bettingInfo gb.MsgBettingInfo) int {
...
func (o *SSC) CheckUnsettledOrderRecord() {
	//1. 找出这个菜种所有未结算订单
...
//得到下棋开彩时间
func (o *SSC) GetNextOpenTime() time.Time {
	return o.nextOpenTime
}

//得到下期请求时间
func (o *SSC) GetNextReqTime() time.Time {
	return o.nextRequestTime
}

//得到当前期数
func (o *SSC) GetCurrentExpect() int {
	return o.currentExpect
}

//得到父类名字
func (o *SSC) GetParentName() string {
	return o.parentName
}

//更新彩票信息(这个函数用于后台有彩票数据更新的情况,这时要更新彩票信息,并通知Gamesrv)
func (o *SSC) UpdateLtryInfo(li gb.LotteryInfo) bool {
