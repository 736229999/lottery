...
//初始化彩票
func Init(lif gb.LotteryInfo) (*HK6, error) {
	ltry := &HK6{}
...
//更新彩票信息
func (o *HK6) updataInfo(newestRecord gb.LtryRecordByNewest) {
	//保存API获取的数据结构
	...
	//下期开彩时间
	o.nextOpenTime = newestRecord.NextOpenTime
	//beego.Debug("下期开彩时间")
...
//开采
func (o *HK6) StartLottery(newestRecord gb.LtryRecordByNewest) {
...
func (o *HK6) CheckLostExpect(gameTag string, newestRecord gb.LtryRecordByNewest, nextExpect int) {
...
//--------------------------------------- 发送到GS的消息 -------------------------------------------------------------------
func (o *HK6) updateGsLtryRecord() error {
...
//更新GameServer的彩票信息
func (o *HK6) updataGsLotteryInfo() {
	//组消息
...
//解析投注
func (o *HK6) AnalyticalBetting(bettingInfo gb.MsgBettingInfo) int {
...
func (o *HK6) CheckUnsettledOrderRecord() {
	//1. 找出这个菜种所有未结算订单
	...
	for expect, orders := range unsettleOrdersMap {
		...
		if o.currentExpect == expect {
			...
			if err != nil {
				beego.Error("严重错误 :  根据彩种,和期数获取开采记录失败 请检查")
				return
			}
			//3.结算同一期的这些订单
...
//得到下期请求时间
func (o *HK6) GetNextReqTime() time.Time {
	return o.nextRequestTime
}

//得到父类名字
func (o *HK6) GetParentName() string {
	return o.parentName
}

//更新彩票信息(这个函数用于后台有彩票数据更新的情况,这时要更新彩票信息,并通知Gamesrv)
func (o *HK6) UpdateLtryInfo(li gb.LotteryInfo) bool {
