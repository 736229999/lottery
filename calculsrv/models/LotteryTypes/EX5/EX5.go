...
//初始化彩票
func Init(lif gb.LotteryInfo) (*EX5, error) {
	ltry := &EX5{}
...
//更新彩票信息
func (o *EX5) updataInfo(newestRecord gb.LtryRecordByNewest) {
	//保存API获取的数据结构
...
//开采
func (o *EX5) StartLottery(newestRecord gb.LtryRecordByNewest) {
...
func (o *EX5) CheckLostExpect(gameTag string, newestRecord gb.LtryRecordByNewest, nextExpect int) {
...
func (o *EX5) updateGsLtryRecord() error {
...
//更新GameServer的彩票信息
func (o *EX5) updataGsLotteryInfo() {
	//组消息
...
//解析投注
func (o *EX5) AnalyticalBetting(bettingInfo gb.MsgBettingInfo) int {
...
func (o *EX5) CheckUnsettledOrderRecord() {
	//1. 找出这个菜种所有未结算订单
...
//得到下棋开彩时间
func (o *EX5) GetNextOpenTime() time.Time {
	return o.nextOpenTime
}

//得到下期请求时间
func (o *EX5) GetNextReqTime() time.Time {
	return o.nextRequestTime
}

//得到当前期数
func (o *EX5) GetCurrentExpect() int {
	return o.currentExpect
}

//得到父类名字
func (o *EX5) GetParentName() string {
	return o.parentName
}

//更新彩票信息(这个函数用于后台有彩票数据更新的情况,这时要更新彩票信息,并通知Gamesrv)
func (o *EX5) UpdateLtryInfo(li gb.LotteryInfo) bool {
